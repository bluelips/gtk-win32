...
install: all
	...
	@copy /b $(HARFBUZZ_DLL_FILENAME).lib $(PREFIX)\lib
	...
	@if exist $(HARFBUZZ_ICU_DLL_FILENAME).dll copy /b $(HARFBUZZ_ICU_DLL_FILENAME).lib $(PREFIX)\lib
	...
	@if exist $(HARFBUZZ_GOBJECT_DLL_FILENAME).dll copy /b $(HARFBUZZ_GOBJECT_DLL_FILENAME).lib $(PREFIX)\lib
